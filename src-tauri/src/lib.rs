...
use commands::{
    ...
    fan::{
        ...
        fan_delete_account, fan_events, fan_forget, fan_home, fan_import_wallet, fan_interests,
        fan_lock, fan_merch_bundles, fan_merch_catalog, fan_prepare_confirmation, fan_push_disable,
