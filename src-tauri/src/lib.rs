...
use commands::{
    fan::{
        ...
        fan_push_enable, fan_push_open_settings, fan_push_status, fan_push_take_target,
    ...
    operator::{
        ...
        operator_ops_overview, operator_push_disable, operator_push_enable, operator_push_sync,
        operator_qr, operator_retry, operator_show_checklist, operator_signal_overview,
