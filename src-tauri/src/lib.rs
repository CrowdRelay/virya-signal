...
use commands::{
    ...
    operator::{
        ...
        operator_autopilot_cancel, operator_autopilot_chief_of_staff, operator_autopilot_overview,
        operator_autopilot_set_authority, operator_events, operator_ops_overview, operator_qr,
        operator_retry, operator_signal_overview, public_cities, public_events, redeem_admission,
