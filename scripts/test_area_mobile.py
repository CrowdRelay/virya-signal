...
class MobileAreaContracts(unittest.TestCase):
    ...
    def test_nearest_location_has_android_fallback_but_claim_stays_strict(self):
        ...
        self.assertIn("viryaAndroidLocationManagerAttempt", bridge)
        self.assertIn("ViryaAndroidLocation", bridge)
        self.assertIn("Android LocationManager locator failed; trying WebView", bridge)
        ...
        self.assertLess(locator.index("viryaWaitForNativeCore"), locator.index("viryaAndroidLocationManagerAttempt"))
        self.assertLess(locator.index("viryaAndroidLocationManagerAttempt"), locator.index("viryaReadBrowserLocatorPosition"))
