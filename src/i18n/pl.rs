pub(super) fn text(key: &'static str) -> &'static str {
    match key {
        ...
        "wallet_ticket_ready" => "Gotowy do wejścia",
        "wallet_ticket_used" => "Bilet został już wykorzystany",
        "wallet_ticket_used_at" => "Wykorzystany {}",
        "wallet_ticket_revoked" => "Bilet został unieważniony",
        "wallet_ticket_expired" => "Bilet wygasł",
        "wallet_ticket_not_claimed" => "Bilet nie został jeszcze aktywowany",
        ...
        "connecting_2" => "ŁĄCZĘ",
        "online" => "ONLINE",
        "order_status_reserved" => "Zarezerwowane",
        "order_status_checkout_created" => "W trakcie płatności",
        "order_status_paid" => "Opłacone",
        "order_status_partially_refunded" => "Częściowy zwrot",
        "order_status_refunded" => "Zwrócone",
        "order_status_expired" => "Wygasłe",
        ...
        "native_error_already_configured" => "Profil jest już skonfigurowany na tym urządzeniu",
        ...
        "autopilot_task_reminder_of" => "Przypomnienie {n} z {total}",
        "autopilot_open_in_panel" => "Otwórz w panelu",
        "autopilot_task_assigned_to" => "Przypisane: {name}",
        "autopilot_task_team_queue" => "Kolejka zespołu",
        "autopilot_task_unassigned" => "Nieprzypisane",
        "autopilot_task_due_label" => "Termin",
        "autopilot_task_expires_label" => "Akceptacja wygasa",
        "database_runtime" => "PostgreSQL runtime",
        "async_io" => "async I/O",
        "area_runtime" => "AREA — źródło stanu",
        "area_credits" => "kredyty",
        "reward_credits_credits_one" => "{reward_credits} kredyt",
        "reward_credits_credits_few" => "{reward_credits} kredyty",
        "reward_credits_credits_many" => "{reward_credits} kredytów",
        "area_reward_added_one" => "Do kolekcji dodano „{track}” i {credits} kredyt nagrody.",
        "area_reward_added_few" => "Do kolekcji dodano „{track}” i {credits} kredyty nagrody.",
        "area_reward_added_many" => "Do kolekcji dodano „{track}” i {credits} kredytów nagrody.",
        ...
        "checklist_section_logistics" => "LOGISTYKA",
        "checklist_section_gate" => "BRAMKA / OFFLINE",
        ...
        "latarnik_release_status_eligible" => "Kwalifikujesz się",
        "latarnik_release_status_notified" => "Powiadomiono",
        "latarnik_release_status_confirmed" => "Potwierdzone",
        "latarnik_release_status_prepared" => "Przygotowane",
        "latarnik_release_status_sent" => "Wysłane",
        "latarnik_release_status_delivered" => "Dostarczone",
        "latarnik_release_status_declined" => "Odrzucone",
        "latarnik_release_status_expired" => "Wygasło",
        "latarnik_release_status_cancelled" => "Anulowane",
        "latarnik_request_status_open" => "W toku",
        "latarnik_request_status_resolved" => "Załatwione",
        "latarnik_request_status_cancelled" => "Anulowane",
        ...
        "subject" => "Temat",
        "to" => "Do",
        // ── Autopilot context labels ──
        "autopilot_context_ticket_yield" => "Rentowność biletów",
        "autopilot_context_fan_lifecycle" => "Cykl życia fana",
        "autopilot_context_campaign_lifecycle" => "Cykl życia kampanii",
        "autopilot_context_merchandising" => "Stan merch",
        "autopilot_context_merch_pricing" => "Rentowność merch",
        "autopilot_context_merch_bundle" => "Pakiety merch",
        "autopilot_context_booking_opportunity" => "Szansa na gig",
        "autopilot_context_outreach" => "Relacje z fanami",
        "autopilot_context_beacon" => "Lokalny latarnik",
        "autopilot_context_show_growth" => "Wzrost frekwencji",
        "autopilot_context_content_supply" => "Dostawa treści",
        "autopilot_context_promotion_budget" => "Rentowność promocji",
        "autopilot_context_experimentation" => "Eksperymenty",
        "autopilot_context_show_operations" => "Obsługa koncertu",
        "autopilot_context_release" => "Autopilot premier",
        "autopilot_context_live_opportunity" => "Festiwale i szanse",
        "autopilot_context_funding" => "Autopilot finansowania",
        "autopilot_context_default" => "Autopilot",
        // ── Autopilot action kind labels ──
        "autopilot_action_ticket_price_change" => "Zmiana ceny biletu",
        "autopilot_action_ticket_capacity_change" => "Powiększenie puli biletów",
        "autopilot_action_fan_lifecycle_message" => "Wiadomość cyklu życia fana",
        "autopilot_action_audience_campaign" => "Kampania audience",
        "autopilot_action_merch_reorder" => "Zlecenie dosprzedaży merch",
        "autopilot_action_merch_price_change" => "Zmiana ceny merch",
        "autopilot_action_merch_bundle" => "Zlecenie pakietu merch",
        "autopilot_action_booking_outreach" => "Kontakt z bookingiem",
        "autopilot_action_outreach" => "Relacje z fanami",
        "autopilot_action_beacon_discovery" => "Odkrywanie lokalnego latarnika",
        "autopilot_action_beacon_outreach" => "Kontakt lokalnego latarnika",
        "autopilot_action_show_growth" => "Dźwignia wzrostu frekwencji / merch",
        "autopilot_action_content_artifact" => "Artefakt treści",
        "autopilot_action_experiment_reallocation" => "Realokacja eksperymentu",
        "autopilot_action_experiment_winner" => "Zwycięzca eksperymentu",
        "autopilot_action_show_task_complete" => "Zadanie koncertowe ukończone",
        "autopilot_action_show_task_escalate" => "Zadanie wymaga człowieka",
        "autopilot_action_promotion_budget_change" => "Zmiana budżetu promocji",
        "autopilot_action_release_milestone" => "Kamień milowy premiery",
        "autopilot_action_live_opportunity_apply" => "Aplikacja na festiwal / szansę",
        "autopilot_action_funding_package_prepare" => "Pakiet finansowania przygotowany",
        "autopilot_action_funding_application_submit" => "Wniosek o finansowanie",
        "autopilot_action_team_assignment_email" => "E-mail przypisania zadania",
        "autopilot_action_default" => "Akcja autopilota",
        // ── Autopilot measurement labels ──
        "autopilot_metric_ticket_revenue_72h" => "Przychód z biletów · 72h",
        "autopilot_metric_merch_gross_proxy_7d" => "Proxy przychodu merch · 7d",
        "autopilot_metric_promotion_roas_7d" => "ROAS promocji · 7d",
        "autopilot_metric_booking_reply_7d" => "Odpowiedź booking · 7d",
        "autopilot_metric_outreach_reply_7d" => "Odpowiedź outreach · 7d",
        "autopilot_metric_audience_ticket_revenue_72h" => "Przychód audience z biletów · 72h",
        "autopilot_metric_show_ticket_revenue_7d" => "Przychód koncertu z biletów · 7d",
        "autopilot_metric_show_growth_surface_clicks_7d" => "Kliknięcia darmowej dystrybucji · 7d",
        "autopilot_metric_show_growth_attributed_ticket_orders_7d" => {
            "Atrybuowane zamówienia biletów · 7d"
        }
        "autopilot_metric_grassroots_activation_replies_14d" => "Odpowiedzi grassroots · 14d",
        "autopilot_metric_default" => "Mierzony efekt",
        // ── Autopilot show task labels ──
        "autopilot_show_task_announcement_published" => "Ogłoszenie opublikowane",
        "autopilot_show_task_ticketing_verified" => "Bilety zweryfikowane",
        "autopilot_show_task_staff_assigned" => "Staff przypisany",
        "autopilot_show_task_offline_snapshot_ready" => "Snapshot offline gotowy",
        "autopilot_show_task_gate_device_charged" => "Urządzenie bramki naładowane",
        "autopilot_show_task_backup_device_ready" => "Urządzenie zapasowe gotowe",
        "autopilot_show_task_network_tested" => "Sieć przetestowana",
        "autopilot_show_task_guestlist_checked" => "Lista gości sprawdzona",
        "autopilot_show_task_post_show_reconciliation" => "Rozliczenie po koncercie",
        "autopilot_show_task_post_show_report" => "Raport po koncercie",
        "autopilot_show_task_default" => "Zadanie koncertowe",
        // ── Autopilot RUM surface labels ──
        "autopilot_rum_surface_virya_www" => "Virya WWW",
        "autopilot_rum_surface_synesthesia" => "Synesthesia",
        "autopilot_rum_surface_virya_signal" => "Virya Signal",
        // ── Autopilot RUM metric labels ──
        "autopilot_rum_metric_lcp" => "LCP",
        "autopilot_rum_metric_inp" => "INP",
        "autopilot_rum_metric_cls" => "CLS ×1000",
        "autopilot_rum_metric_ttfb" => "TTFB",
        "autopilot_rum_metric_boot_interactive" => "boot→interaktywny",
        "autopilot_rum_metric_room_load" => "ładowanie pokoju",
        "autopilot_rum_metric_transition" => "przejście",
        "autopilot_rum_metric_frame_hitch" => "zacięcie klatki",
        "autopilot_rum_metric_cold_start" => "zimny start",
        "autopilot_rum_metric_api_latency" => "latencja API",
        "autopilot_rum_metric_screen_transition" => "przejście ekranu",
        // ── Autopilot show growth prefix ──
        "autopilot_show_growth_prefix" => "Wzrost koncertu",
        // ── Operator eyebrows ──
        "ticketing_eyebrow" => "BILETY",
        "merch_desk_eyebrow" => "STOISKO MERCH",
        "concert_signal_eyebrow" => "SYGNAŁ KONCERTU",
        "owner_only_eyebrow" => "TYLKO OWNER",
        // ── Affiliate ──
        "affiliate_partner_pill" => "THOMANN · AFFILIATE",
        // ── Operator commerce ──
        "claim_token_label" => "Token roszczenia",
        "pool_slug_placeholder" => "pool slug",
        // ── Beacon danger zone success ──
        "latarnik_logout_done" => "Latarnik wylogowany. Przeładowuję…",
        "latarnik_leave_done" => "Kanał Latarnika wyłączony. Przeładowuję…",
        "latarnik_dnc_done" => "Nie kontaktować się — zarejestrowane. Przeładowuję…",
        // ── Remaining hardcoded eyebrows/labels ──
        "live_operations" => "OPERACJE NA ŻYWO",
        "viryaos_autopilot" => "VIRYAOS AUTOPILOT",
        "continue_synesthesia" => "Kontynuuj →",
        "synesthesia_eyebrow" => "SYNESTHESIA",
        "virya_staff_eyebrow" => "VIRYA / STAFF",
        // ── 15 synced autopilot action kinds ──
        "autopilot_action_playlist_placement_verify" => "Weryfikacja umieszczenia playlisty",
        "autopilot_action_beacon_invite_batch" => "Pula zaproszeń latarnika",
        "autopilot_action_outreach_discovery" => "Odkrywanie możliwości kontaktów",
        "autopilot_action_booking_target_discovery" => "Odkrywanie celów rezerwacji",
        "autopilot_action_editorial_pitch_escalate" => "Eskalacja pitchu redakcyjnego",
        "autopilot_action_opportunity_terms_counter" => "Kontrpropozycja warunków",
        "autopilot_action_opportunity_terms_accept" => "Akceptacja warunków",
        "autopilot_action_growth_opportunity_raise" => "Wzrost możliwości",
        "autopilot_action_growth_debt_raise" => "Dług wzrostu",
        ...
        "autopilot_beacon_invite_batch_detail" => "{0} zaproszeń · {1}",
        "autopilot_outreach_discovery_detail" => "{0} kandydatów",
        "autopilot_booking_target_discovery_detail" => "{0} celów",
