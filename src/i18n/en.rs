pub(super) fn text(key: &'static str) -> &'static str {
    match key {
        ...
        "order_status_checkout_created" => "Awaiting payment",
        ...
        "autopilot_task_reminder_of" => "Reminder {n} of {total}",
        "autopilot_open_in_panel" => "Open in panel",
        "autopilot_task_assigned_to" => "Assigned to {name}",
        "autopilot_task_team_queue" => "Team queue",
        "autopilot_task_unassigned" => "Unassigned",
        "autopilot_task_due_label" => "Due",
        "autopilot_task_expires_label" => "Approval expires",
        ...
        "latarnik_release_status_eligible" => "Eligible",
        "latarnik_release_status_notified" => "Notified",
        "latarnik_release_status_confirmed" => "Confirmed",
        "latarnik_release_status_prepared" => "Prepared",
        "latarnik_release_status_sent" => "Sent",
        "latarnik_release_status_delivered" => "Delivered",
        "latarnik_release_status_declined" => "Declined",
        "latarnik_release_status_expired" => "Expired",
        "latarnik_release_status_cancelled" => "Cancelled",
        "latarnik_request_status_open" => "Open",
        "latarnik_request_status_resolved" => "Resolved",
        "latarnik_request_status_cancelled" => "Cancelled",
        ...
        "autopilot_context_ticket_yield" => "Ticket Yield",
        "autopilot_context_fan_lifecycle" => "Fan Lifecycle",
        "autopilot_context_campaign_lifecycle" => "Campaign Lifecycle",
        "autopilot_context_merchandising" => "Merch Stock",
        "autopilot_context_merch_pricing" => "Merch Yield",
        "autopilot_context_merch_bundle" => "Merch Bundles",
        "autopilot_context_booking_opportunity" => "Gig Opportunity",
        "autopilot_context_outreach" => "Relationship Outreach",
        "autopilot_context_beacon" => "Local Beacon",
        "autopilot_context_show_growth" => "Attendance Growth",
        "autopilot_context_content_supply" => "Content Supply",
        "autopilot_context_promotion_budget" => "Promotion Yield",
        "autopilot_context_experimentation" => "Experiments",
        "autopilot_context_show_operations" => "Show Operations",
        "autopilot_context_release" => "Release Autopilot",
        "autopilot_context_live_opportunity" => "Festival & Opportunity",
        "autopilot_context_funding" => "Funding Autopilot",
        "autopilot_context_default" => "Autopilot",
        // ── Autopilot action kind labels ──
        "autopilot_action_ticket_price_change" => "Ticket price changed",
        "autopilot_action_ticket_capacity_change" => "Ticket pool expanded",
        "autopilot_action_fan_lifecycle_message" => "Fan lifecycle message",
        "autopilot_action_audience_campaign" => "Audience campaign",
        "autopilot_action_merch_reorder" => "Merch reorder request",
        "autopilot_action_merch_price_change" => "Merch price changed",
        "autopilot_action_merch_bundle" => "Merch bundle request",
        "autopilot_action_booking_outreach" => "Booking outreach",
        "autopilot_action_outreach" => "Relationship outreach",
        "autopilot_action_beacon_discovery" => "Local beacon discovery",
        "autopilot_action_beacon_outreach" => "Local beacon outreach",
        "autopilot_action_show_growth" => "Attendance / merch growth lever",
        "autopilot_action_content_artifact" => "Content artifact",
        "autopilot_action_experiment_reallocation" => "Experiment reallocation",
        "autopilot_action_experiment_winner" => "Experiment winner",
        "autopilot_action_show_task_complete" => "Show task completed",
        "autopilot_action_show_task_escalate" => "Show task needs human",
        "autopilot_action_promotion_budget_change" => "Promotion budget change",
        "autopilot_action_release_milestone" => "Release milestone",
        "autopilot_action_live_opportunity_apply" => "Festival / opportunity application",
        "autopilot_action_funding_package_prepare" => "Funding package prepared",
        "autopilot_action_funding_application_submit" => "Funding application",
        "autopilot_action_team_assignment_email" => "Team assignment email",
        "autopilot_action_default" => "Autopilot action",
        // ── Autopilot measurement labels ──
        "autopilot_metric_ticket_revenue_72h" => "Ticket revenue · 72h",
        "autopilot_metric_merch_gross_proxy_7d" => "Merch gross proxy · 7d",
        "autopilot_metric_promotion_roas_7d" => "Promotion ROAS · 7d",
        "autopilot_metric_booking_reply_7d" => "Booking reply · 7d",
        "autopilot_metric_outreach_reply_7d" => "Outreach reply · 7d",
        "autopilot_metric_audience_ticket_revenue_72h" => "Audience ticket revenue · 72h",
        "autopilot_metric_show_ticket_revenue_7d" => "Show ticket revenue · 7d",
        "autopilot_metric_show_growth_surface_clicks_7d" => "Free distribution clicks · 7d",
        "autopilot_metric_show_growth_attributed_ticket_orders_7d" => {
            "Attributed ticket orders · 7d"
        }
        "autopilot_metric_grassroots_activation_replies_14d" => "Grassroots replies · 14d",
        "autopilot_metric_default" => "Measured effect",
        // ── Autopilot show task labels ──
        "autopilot_show_task_announcement_published" => "Announcement published",
        "autopilot_show_task_ticketing_verified" => "Ticketing verified",
        "autopilot_show_task_staff_assigned" => "Staff assigned",
        "autopilot_show_task_offline_snapshot_ready" => "Offline snapshot ready",
        "autopilot_show_task_gate_device_charged" => "Gate device charged",
        "autopilot_show_task_backup_device_ready" => "Backup device ready",
        "autopilot_show_task_network_tested" => "Network tested",
        "autopilot_show_task_guestlist_checked" => "Guest list checked",
        "autopilot_show_task_post_show_reconciliation" => "Post-show reconciliation",
        "autopilot_show_task_post_show_report" => "Post-show report",
        "autopilot_show_task_default" => "Show task",
        ...
        "autopilot_rum_metric_boot_interactive" => "boot→interactive",
        "autopilot_rum_metric_room_load" => "room load",
        "autopilot_rum_metric_transition" => "transition",
        "autopilot_rum_metric_frame_hitch" => "frame hitch",
        "autopilot_rum_metric_cold_start" => "cold start",
        "autopilot_rum_metric_api_latency" => "API latency",
        "autopilot_rum_metric_screen_transition" => "screen transition",
        // ── Autopilot show growth prefix ──
        "autopilot_show_growth_prefix" => "Show growth",
        // ── Operator eyebrows ──
        "ticketing_eyebrow" => "TICKETING",
        "merch_desk_eyebrow" => "MERCH DESK",
        "concert_signal_eyebrow" => "CONCERT SIGNAL",
        "owner_only_eyebrow" => "OWNER ONLY",
        // ── Affiliate ──
        ...
        "latarnik_logout_done" => "Latarnik logged out. Reloading…",
        "latarnik_leave_done" => "Latarnik channel closed. Reloading…",
        "latarnik_dnc_done" => "Do-not-contact registered. Reloading…",
        // ── Remaining hardcoded eyebrows/labels ──
        "live_operations" => "LIVE OPERATIONS",
        "viryaos_autopilot" => "VIRYAOS AUTOPILOT",
        "continue_synesthesia" => "Continue →",
        "synesthesia_eyebrow" => "SYNESTHESIA",
        "virya_staff_eyebrow" => "VIRYA / STAFF",
        // ── 15 synced autopilot action kinds ──
        "autopilot_action_playlist_placement_verify" => "Playlist placement verify",
        "autopilot_action_beacon_invite_batch" => "Beacon invite batch",
        "autopilot_action_outreach_discovery" => "Outreach discovery",
        "autopilot_action_booking_target_discovery" => "Booking target discovery",
        "autopilot_action_editorial_pitch_escalate" => "Editorial pitch escalate",
        "autopilot_action_opportunity_terms_counter" => "Counter opportunity terms",
        "autopilot_action_opportunity_terms_accept" => "Accept opportunity terms",
        "autopilot_action_growth_opportunity_raise" => "Raise growth opportunity",
        "autopilot_action_growth_debt_raise" => "Raise growth debt",
        ...
        "autopilot_beacon_invite_batch_detail" => "{0} invites · {1}",
        "autopilot_outreach_discovery_detail" => "{0} candidates",
        "autopilot_booking_target_discovery_detail" => "{0} targets",
